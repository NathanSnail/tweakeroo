...
local content =
	"<MagicNumbers\n" ..
	"\n" ..
	"VIRTUAL_RESOLUTION_X=\"" .. math.floor(get_setting("zoom") * 427) .. "\"\n" ..
	"VIRTUAL_RESOLUTION_Y=\"" .. math.floor(get_setting("zoom") * 242) .. "\"\n" ..
	"STREAMING_CHUNK_TARGET=\"" .. get_setting_i("chunks") .. "\"\n" ..
	"CAMERA_MOUSE_INTERPOLATION_SPEED=\"" .. 0.25 * get_setting("mouse") .. "\"\n" ..
	"CAMERA_POSITION_INTERPOLATION_SPEED=\"" .. 3.52 * get_setting("position") .. "\"\n" ..
	"DESIGN_DAY_CYCLE_SPEED=\"" .. 0.0015 * get_setting("day") .. "\"\n" ..
	"APPARITION_MIN_BONES_REQUIRED=\"" .. get_setting_i("bones") .. "\"\n" ..
	"BIOME_APPARITION_CHANCE=\"" .. get_setting_i("ghost") .. "\"\n" ..
	"CAMERA_RECOIL_AMOUNT=\"" .. get_setting("recoil") .. "\"\n" ..
	"CAMERA_RECOIL_ATTACK_SPEED=\"" .. 0.15 * get_setting("attack") .. "\"\n" ..
	"CAMERA_RECOIL_RELEASE_SPEED=\"" .. 15 * get_setting("release") .. "\"\n" ..
	"STREAMING_AUTOSAVE_PERIOD_SECONDS=\"" .. get_setting_i("autosave") .. "\"\n" ..
	...
	"UI_MAX_PERKS_VISIBLE=\"" .. get_setting_i("perk") .. "\"\n" ..
	"UI_LOW_HP_THRESHOLD=\"" .. get_setting("hp") / 25 .. "\"\n" ..
	"UI_LOW_HP_WARNING_FLASH_FREQUENCY=\"" .. get_setting("flash") .. "\"\n" ..
	"REPORT_DAMAGE_SCALE=\"" .. get_setting("damage") .. "\"\n" ..
	"GRID_MAX_UPDATES_PER_FRAME=\"" .. get_setting_i("updates") .. "\"\n" ..
...
c = c:gsub(", tex_coord_fogofwar",
	", vec2(tex_coord_fogofwar.x,tex_coord_fogofwar.y - (1.0-" ..
	string.format("%.3f", get_setting("zoom")) .. ")*0.044)") -- fun ~= 0.044
